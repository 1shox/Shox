        ...
        <b-form class="mb-5" @submit.prevent="sendMessage">
          ...
          <b-form-group id="input-group-3" label="Your Message">
            <b-form-textarea
              ...
              no-resize
              rows="3"
              placeholder="Watsup Shox, are you available for.."
              required
            ></b-form-textarea>
          </b-form-group>
...
export default {
  ...
  head: {
    title: "Contact 📧 - Shaxriyor",
    meta: [
      {
        hid: "description",
        name: "description",
        content: "Do you have any enquires? Send a message now to Shaxriyor"
      },
      {
        hid: "og:title",
        name: "og:title",
        content: "Contact 📧 - Shaxriyor"
      },
      {
